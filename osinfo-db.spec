...
Source0  : https://releases.pagure.org/libosinfo/osinfo-db-20240701.tar.xz
Source1  : https://releases.pagure.org/libosinfo/osinfo-db-20240701.tar.xz.asc
...
%setup -q -n osinfo-db-20240701
cd %{_builddir}/osinfo-db-20240701
%patch -P 1 -p1
pushd ..
cp -a osinfo-db-20240701 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720102127
